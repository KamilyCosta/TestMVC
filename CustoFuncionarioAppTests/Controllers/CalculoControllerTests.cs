...
namespace CustoFuncionarioApp.Controllers.Tests
{
    ...
    public class CalculoControllerTests
    {
        ...
        [DataRow(3000.00, 0.00, 0.00, 0.00)]
        [DataRow(3000.00, 500.00, 200.00d, 300.00d)]
        [DataRow(1500.00, 300.00, 150.00d, 100.00d)]
        [DataRow(4000.00, 700.00, 250.00d, 400.00d)]
        ...
        [TestMethod]
        [DataRow(3000.00, 500.00, 200.00, 300.00)]
        [DataRow(1500.00, 300.00, 150.00, 100.00)]
        [DataRow(4000.00, 700.00, 250.00, 400.00)]
        ...
        [TestMethod()]
        public void RelatorioController_DeveRetornarView()
        {
            var custo = new Custo(); 
            var resultado = controller.Relatorio(custo) as ViewResult;
            Assert.IsNotNull(resultado);
            ...
            [TestMethod]
            public void TestarINSS_Valor()
            {
                // Arrange
                var custo = new Custo { SalarioBruto = 2000M };
            ...
            {
                // Arrange
                var custo = new Custo { SalarioBruto = 3000M };
            ...
            [TestMethod]
            public void Testar13oSalario()
            {
                // Arrange
                var custo = new Custo { SalarioBruto = 1500M };
